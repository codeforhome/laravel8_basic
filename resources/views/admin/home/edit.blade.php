            ...
            <form action="{{ url('about/update/'.$homeabout -> id) }}" method="post" enctype="multipart/form-data">
              @csrf
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" name="title" value="{{ $homeabout -> title }}" placeholder="About Title">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="long_dis"
                     rows="3">{{ $homeabout -> long_dis }}</textarea>
                </div>
